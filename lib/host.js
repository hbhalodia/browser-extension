 ...
 *
 * Loaded as a content script alongside detect.js and rest.js. Host display
 * names live with the popup's HostBadge, which owns their presentation and
 * localization, so this module stays detection-only.
 */
(function () {
  'use strict';
